        ...
        <div class="lg:col-span-7 flex flex-col justify-center px-6 sm:px-16 lg:px-24 xl:px-32 py-16 bg-white min-h-screen w-full">
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-500 text-sm font-medium">Daftar gratis untuk mulai memantau kesehatan reproduksi Anda.</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-[11px] font-bold text-gray-400 tracking-wider uppercase mb-2">NAMA LENGKAP</label>
                    ...
                    <div x-data="{ showConfirmPassword: false }">
                        <label for="password_confirmation" class="block text-[11px] font-bold text-gray-400 tracking-wider uppercase mb-2">KONFIRMASI KATA SANDI</label>
                        <div class="relative rounded-xl shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
                                <!-- Lock SVG Icon -->
                                <svg class="w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
